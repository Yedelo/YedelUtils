...
export let serverListPing = mc.func_147104_D()?.field_78844_e || -1 // Ping shown in server list, doesn't change
...
export function listPing() {
  ...
  if (mc.func_71356_B() /* singleplayer */) return ChatLib.chat(`${logo} &cThis method doesn't work in singleplayer!`);
