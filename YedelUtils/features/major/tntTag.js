import {setInventorySlotContents} from '../../utils/mappings'
...
register('chat', () => { // Start of round
  ...
  if (Yettings.clickables) {
    ...
    inventory[setInventorySlotContents](Yettings.playAgainItem - 1, playItem)
    inventory[setInventorySlotContents](Yettings.returnToLobbyItem - 1, leaveItem)
  }
  if (!Yettings.bountyHunting) return
  whoCheck = true
  ChatLib.command('who')
