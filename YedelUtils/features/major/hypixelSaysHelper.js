...
import {items} from '../../stuff/constants'
...
register('worldLoad', () => { // Hypixel says check
...
register('renderItemIntoGui', (item, x, y) => { // Check for items to highlight
  if (!playing) return
...
register('playerInteract', (action, position, event) => { // Cancel wrong button press
