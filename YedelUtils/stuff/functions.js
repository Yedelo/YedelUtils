...
const formatter = new DecimalFormat("#,###")
...
/** 
* Chats a changelog message for the mod.
**/

export function welcomeMessage () {
  ChatLib.chat('')
  ChatLib.chat(ChatLib.getCenteredText('&7&l--< &9&lYedelUtils &7&l2.4.0 >--'))
  ChatLib.chat(ChatLib.getCenteredText('&9Features:'))
  ChatLib.chat(ChatLib.getCenteredText('&7&nEasy atlas verdicts:'))
  ChatLib.chat(ChatLib.getCenteredText('&7Adds keybinds for the two atlas verdicts'))
  ChatLib.chat('')
  ChatLib.chat(ChatLib.getCenteredText('&9Other:'))
  ChatLib.chat(ChatLib.getCenteredText('&9/settext &7now supports variables with ${the variable}'))
  ChatLib.chat(ChatLib.getCenteredText('&9Improved strength indicators'))
  ChatLib.chat('')
