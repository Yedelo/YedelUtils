...
export const YedelCheck = Java.type('at.yedel.yedelmod.YedelCheck')
export const isYedelModActive = typeof YedelCheck == 'function'

export const logo = "&9&l< Yedel&7&lUtils &9&l>"
export const version = JSON.parse(FileLib.read('YedelUtils', 'metadata.json')).version

export const mc = Client.getMinecraft()

export const notifications = EssentialAPI.getNotifications()
